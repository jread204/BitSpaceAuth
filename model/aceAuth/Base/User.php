...
abstract class User implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\aceAuth\\Map\\UserTableMap';
    ...
    /**
     * The value for the remember_me field.
     * @var        string
     */
    protected $remember_me;

    /**
     * The value for the enrollmentid field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of aceAuth\Base\User object.
     */
    ...
    /**
     * Get the [remember_me] column value.
     * 
     * @return string
     */
    ...
    /**
     * Get the [enrollmentid] column value.
     * 
     * @return string
     */
     ...
     * @return $this|\aceAuth\User The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [remember_me] column.
     * 
     * @param string $v new value
     * @return $this|\aceAuth\User The current object (for fluent API support)
     */
    public function setRememberMe($v)
    {
        ...
        if ($this->remember_me !== $v) {
            $this->remember_me = $v;
            $this->modifiedColumns[UserTableMap::COL_REMEMBER_ME] = true;
        }
    ...
    /**
     * Set the value of [enrollmentid] column.
     * 
     * @param string $v new value
     * @return $this|\aceAuth\User The current object (for fluent API support)
     */
    public function setEnrollmentId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->enrollmentid !== $v) {
            $this->enrollmentid = $v;
            $this->modifiedColumns[UserTableMap::COL_ENROLLMENTID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserTableMap::translateFieldName('RememberMe', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remember_me = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UserTableMap::translateFieldName('EnrollmentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->enrollmentid = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\aceAuth\\User'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_REMEMBER_ME)) {
            $modifiedColumns[':p' . $index++]  = 'remember_me';
        }
        if ($this->isColumnModified(UserTableMap::COL_ENROLLMENTID)) {
            $modifiedColumns[':p' . $index++]  = 'enrollmentId';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'email':                        
                        ...
                        break;
                    case 'remember_me':                        
                        $stmt->bindValue($identifier, $this->remember_me, PDO::PARAM_STR);
                        break;
                    case 'enrollmentId':                        
                        $stmt->bindValue($identifier, $this->enrollmentid, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getRememberMe(),
            $keys[5] => $this->getEnrollmentId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setRememberMe($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setEnrollmentId($arr[$keys[5]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\aceAuth\User The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_REMEMBER_ME)) {
            $criteria->add(UserTableMap::COL_REMEMBER_ME, $this->remember_me);
        }
        if ($this->isColumnModified(UserTableMap::COL_ENROLLMENTID)) {
            $criteria->add(UserTableMap::COL_ENROLLMENTID, $this->enrollmentid);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \aceAuth\User (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRememberMe($this->getRememberMe());
        $copyObj->setEnrollmentId($this->getEnrollmentId());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \aceAuth\User Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUserGroups($overrideExisting = true)
    {
        ...
        $this->collUserGroups->setModel('\aceAuth\UserGroup');
    }
     ...
     * @return ObjectCollection|ChildUserGroup[] List of ChildUserGroup objects
     */
    public function getUserGroupsJoinGroupRole(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserGroupQuery::create(null, $criteria);
        $query->joinWith('GroupRole', $joinBehavior);
    ...
    public function initGroups()
    {
        ...
        $this->collGroups->setModel('\aceAuth\Group');
    }
