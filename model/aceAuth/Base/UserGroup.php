...
abstract class UserGroup implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\aceAuth\\Map\\UserGroupTableMap';
    ...
    /**
     * Initializes internal state of aceAuth\Base\UserGroup object.
     */
     ...
     * @return $this|\aceAuth\UserGroup The current object (for fluent API support)
     */
    ...
    public function setRoleId($v)
    {
        ...
        if ($this->role_id !== $v) {
            $this->role_id = $v;
            $this->modifiedColumns[UserGroupTableMap::COL_ROLE_ID] = true;
        }

        if ($this->aGroupRole !== null && $this->aGroupRole->getId() !== $v) {
            $this->aGroupRole = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserGroupTableMap::translateFieldName('RoleId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\aceAuth\\UserGroup'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aGroupRole !== null && $this->role_id !== $this->aGroupRole->getId()) {
            $this->aGroupRole = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aGroupRole !== null) {
                if ($this->aGroupRole->isModified() || $this->aGroupRole->isNew()) {
                    $affectedRows += $this->aGroupRole->save($con);
                }
                $this->setGroupRole($this->aGroupRole);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserGroupTableMap::COL_ROLE_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aGroupRole) {
                ...
                $result[$key] = $this->aGroupRole->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\aceAuth\UserGroup The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserGroupTableMap::COL_ROLE_ID)) {
            $criteria->add(UserGroupTableMap::COL_ROLE_ID, $this->role_id);
        }
    ...
    public function hashCode()
    {
        ...
        //relation Groups_FK to table groups
        ...
        //relation Users_FK to table users
     ...
     * objects.
     *
     * @param      object $copyObj An object of \aceAuth\UserGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \aceAuth\UserGroup Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function setGroupRole(ChildRole $v = null)
    {
        if ($v === null) {
            $this->setRoleId(NULL);
        } else {
     ...
     * @throws PropelException
     */
    public function getGroupRole(ConnectionInterface $con = null)
    {
        if ($this->aGroupRole === null && ($this->role_id !== null)) {
            $this->aGroupRole = ChildRoleQuery::create()->findPk($this->role_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGroupRole->addUserRoles($this);
             */
        }

        return $this->aGroupRole;
    }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aGroupRole) {
            $this->aGroupRole->removeUserRole($this);
        }
        $this->user_id = null;
        $this->group_id = null;
        $this->role_id = null;
