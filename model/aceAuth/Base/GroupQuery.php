 ...
 *
 * @method     ChildGroupQuery leftJoinGroupRole($relationAlias = null) Adds a LEFT JOIN clause to the query using the GroupRole relation
 * @method     ChildGroupQuery rightJoinGroupRole($relationAlias = null) Adds a RIGHT JOIN clause to the query using the GroupRole relation
 * @method     ChildGroupQuery innerJoinGroupRole($relationAlias = null) Adds a INNER JOIN clause to the query using the GroupRole relation
 *
 ...
 *
 * @method     \aceAuth\RoleQuery|\aceAuth\UserGroupQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class GroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \aceAuth\Base\GroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\aceAuth\\Group', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, description, name FROM groups WHERE id = :p0';
        try {
     ...
     *
     * @param \aceAuth\Role|ObjectCollection $role the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
