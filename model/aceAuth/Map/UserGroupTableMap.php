...
class UserGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'aceAuth.Map.UserGroupTableMap';
     ...
     */
    const OM_CLASS = '\\aceAuth\\UserGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'aceAuth.UserGroup';
     ...
     */
    const COL_USER_ID = 'usergroup.User_Id';

    /**
     * the column name for the Group_Id field
     */
    const COL_GROUP_ID = 'usergroup.Group_Id';

    /**
     * the column name for the Role_id field
     */
    const COL_ROLE_ID = 'usergroup.Role_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UserId', 'GroupId', 'RoleId', ),
        self::TYPE_CAMELNAME     => array('userId', 'groupId', 'roleId', ),
        self::TYPE_COLNAME       => array(UserGroupTableMap::COL_USER_ID, UserGroupTableMap::COL_GROUP_ID, UserGroupTableMap::COL_ROLE_ID, ),
        self::TYPE_FIELDNAME     => array('User_Id', 'Group_Id', 'Role_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UserId' => 0, 'GroupId' => 1, 'RoleId' => 2, ),
        self::TYPE_CAMELNAME     => array('userId' => 0, 'groupId' => 1, 'roleId' => 2, ),
        self::TYPE_COLNAME       => array(UserGroupTableMap::COL_USER_ID => 0, UserGroupTableMap::COL_GROUP_ID => 1, UserGroupTableMap::COL_ROLE_ID => 2, ),
        self::TYPE_FIELDNAME     => array('User_Id' => 0, 'Group_Id' => 1, 'Role_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\aceAuth\\UserGroup');
    ...
    {
        $this->addRelation('Group', '\\aceAuth\\Group', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':Group_Id',
    1 => ':id',
        ...
        $this->addRelation('User', '\\aceAuth\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':User_Id',
    1 => ':id',
        ...
        $this->addRelation('GroupRole', '\\aceAuth\\Role', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':Role_id',
    1 => ':id',
     ...
     * and findPk*() calls.
     *
     * @param \aceAuth\UserGroup $obj A \aceAuth\UserGroup object.
     ...
     *
     * @param mixed $value A \aceAuth\UserGroup object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \aceAuth\UserGroup) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \aceAuth\UserGroup object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserGroupTableMap::COL_ROLE_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \aceAuth\UserGroup) { // it's a model object
